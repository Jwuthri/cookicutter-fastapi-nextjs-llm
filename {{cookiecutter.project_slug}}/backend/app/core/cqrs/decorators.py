...
from .interfaces import ICommand, IQuery, ICommandHandler, IQueryHandler
...
def cached_query(
    ...
    def decorator(handler_class: Type[IQueryHandler]):
        ...
        original_get_cached_result = handler_class._get_cached_result
        original_cache_result = handler_class._cache_result
