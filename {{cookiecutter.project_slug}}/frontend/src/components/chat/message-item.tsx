                ...
                <div className="prose prose-invert max-w-none">
                  <ReactMarkdown
                    components={{
                      ...
                      h1: ({ children }: any) => <h1 className="text-xl font-bold mb-3 text-white">{children}</h1>,
                      h2: ({ children }: any) => <h2 className="text-lg font-bold mb-2 text-white">{children}</h2>,
                      h3: ({ children }: any) => <h3 className="text-md font-bold mb-2 text-white">{children}</h3>,
                      ul: ({ children }: any) => <ul className="list-disc list-inside mb-3 space-y-1">{children}</ul>,
                      ol: ({ children }: any) => <ol className="list-decimal list-inside mb-3 space-y-1">{children}</ol>,
                      li: ({ children }: any) => <li className="text-white/90">{children}</li>,
                      code: ({ children }: any) => (
